...
//
//-----------------------------------------------------------------------------
#ifndef __CTPMARKETDATA_H__
#define __CTPMARKETDATA_H__

#include "zmq_helper.h"
#include "thost_se/ThostFtdcMdApi.h"
...
public:
    ...
    int SubscribeContract(std::vector<char*> symbols);
